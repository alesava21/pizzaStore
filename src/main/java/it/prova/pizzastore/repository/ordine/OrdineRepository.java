...
public interface OrdineRepository extends CrudRepository<Ordine, Long>, CustumOrdineRepository{
	...
	Integer contaPizzeOrderedBetween(LocalDate dataInizio, LocalDate dataFine);
